		...
		try {
			if (flavour.contains("App") || flavour.equalsIgnoreCase("MobileWeb")) {
				...
				if (DriverSession.getBrowserName().equalsIgnoreCase("firefox")) {
					...
					profile.setPreference("browser.download.dir", "/Users/kiwitech/Downloads/");
					profile.setPreference("browser.download.downloadDir", "/Users/kiwitech/Downloads/");
					...
					profile.setPreference("browser.helperApps.neverAsk.saveToDisk",
							"text/anytext ,application/x-msexcel,application/excel,application/x-excel,application/vnd.ms-excel,text/plain,text/html,application/plain,application/pdf,application/xls,text/csv");
					...
					// selenium 3 and above
					if (!GlobalParam.TESTNG_EXECUTION) {
						driverPath = GlobalParam.suiteProp.getProperty("WEB_DRIVER_FIREFOX");
				...
				driver = driver1;
				Keywords.setScreenResolution(driver);
